...
#define CONFIG_MINI6410		1	/* on a MINI6410 Board  */
...
#define CONFIG_IDENT_STRING	" for MINI6400"
...
#define CONFIG_NAND_ENV_DST	(CONFIG_SYS_UBOOT_BASE + (1024 * 1024))
...
#define CONFIG_SYS_NAND_U_BOOT_SIZE	CONFIG_SYS_UBOOT_SIZE	/* Size of RAM U-Boot image   */
...
#define CONFIG_BOOTARGS		"console=ttySAC,115200 " MTDPARTS_DEFAULT
